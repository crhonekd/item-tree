...
1. **The Edit tool requires a prior *Read-tool* read of the file.** Viewing a file with
...
2. **Don't batch many independent tool calls in one turn here.** Parallel calls have
